  ...
  return (
    <div className="app-container md:flex md:justify-between md:mt-20 mb-20 mt-3">
      <div className=" md:p-5 md:w-7/12 lg:w-6/12">
        <h1 className="text-3xl font-bold text-left mb-3 md:w-11/12"> A WEB 3 DECENTRALIZED SPORTS <spam className='text-app-orange'> MARKET PLACE </spam></h1>
        <p className="mb-5 text-sm md:w-10/12 text-justify"> Exclusive way to earn big from the multiple systems for tips
        ...
        <p className='mb-5 text-sm md:w-10/12 text-justify'> Are you a Sport enthusiast but do not know or have the skills and knowledge on
