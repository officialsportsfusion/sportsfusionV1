    ...
    return (
        <div className='app-container flex justify-center'>
          ...
          <div className='flex justify-between'>
            <h2 className=' hidden text-white text-center text-4xl font-bold lg:contents'>My Account</h2>
        <div className='hidden lg:contents'><button className='bg-gradient-to-r from-app-sky  to-app-orange p-2 rounded-lg cursor-pointer '>BECOME A TIPSTER</button></div>
            </div>
            <h2 className='text-white text-center text-4xl font-bold lg:hidden'>My Account</h2>
            <div className="flex justify-center item-center mt-8">
               <Image src={Img} alt='my-profile-pic' className='rounded-full'/> 
            </div>
           <div className=' flex justify-end items-right mt-4'> <button className=' bg-gradient-to-r from-app-sky  to-app-orange p-2 rounded-lg cursor-pointer lg:hidden'>BECOME A TIPSTER</button></div>
     ...
     <div className='flex justify-between mt-10 lg:w-9/12' >
            ...
            <button className='bg-app-orange-light p-2 rounded-3xl text-app-black font-medium'> $ 0.00</button>
            </div>
            <div className='text-center'>
            <p className='text-app-orange-thick'>Rank</p>
            <button className='bg-app-orange-light p-2 w-20 rounded-3xl text-app-black font-medium'> User</button>
            </div>
            <div className='text-center'>
            <p className='text-app-orange-thick'> Fund</p>
            <button className='bg-app-orange-light p-2 rounded-3xl text-app-black font-medium'>Fund/Withdraw</button>
            </div>
            </div>
     </div>

            <div className='bg-app-orange mt-8 py-2 px-4'><p>Todays bet</p></div>
            <Table data={data}/>
            ...
            <div>
            <p className ='mb-4 py-4  border-b-[#4E443D] border-b-[2px]'>History</p>
                        ...
                        data && data.length !== 0 ?
                            data.map((item, index) => {
                                return <tr key={index} className="border-b-solid border-b-[#4E443D] border-b-[1px] last-of-type:border-none">
                                    ...
                                    <td className="p-1 text-center border border-[#4E443D] max-w-[12rem]"><p className="inline-flex flex-col ml-1 min-[420px]:text-md"><span className='text-[#AAAAAA]'>{item.event.match}</span></p></td>


                                    <td className="pl-2 text-center  border border-[#4E443D] "><p className="inline-flex flex-col  min-[420px]:text-sm"><span>{item.bettingType.odd}</span><span>{item.bettingType.duration}</span></p></td>
