        ...
        <div className="w-11/12 md:w-8/12 lg:w-10/12 ">
          ...
          <div className="">
            <input
              type="email"
              placeholder="OTP"
              className="w-full h-12 p-3 rounded-xl my-4 text-2xl"
            />
          </div>
...
const Btn = ({ icon }) => {
  return (
    <div className="bg-gradient-to-r from-app-orange via-app-sky to-app-orange w-[3.25rem] h-[2.25rem] rounded-lg p-[1px]">
      {" "}
      <span className="bg-app-black w-full h-full p-[1px] text-sm rounded-lg inline-grid place-items-center">
        {" "}
        {icon}{" "}
