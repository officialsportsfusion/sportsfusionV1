...
import ConcaveArc from '@images/arc.svg'
import ConvexArc from '@images/arc2.svg'
    ...
    return (
        <section className='w-full pt-16 md:pt-0'>
            <div className='app-container'>
                ...
                <div className='grid items-center mt-6 gap-y-12 md:mt-12 md:grid-cols-12 pb-6 relative'>
    ...
    return (
        <div className='mb-14 mt-20 relative md:mt-24 md:mb-16'>
            <div className='w-full h-16 absolute bottom-full z-0 md:h-20'>
                <div className='h-full absolute top-0 left-1/2 right-[14.5%] md:right-[11%]'><Image src={ConcaveArc} alt='' width='200' height='80' className='w-full h-full' />
                </div>
            </div>
            ...
            <div className='w-full h-16 absolute top-full z-0 md:h-20'>
                <div className='h-full absolute top-0 right-1/2 left-[14.5%] md:left-[11%]'>
                    <Image src={ConvexArc} alt='' width='200' height='80' className='w-full h-full' />
                </div>
            </div>
        </div>
    )
